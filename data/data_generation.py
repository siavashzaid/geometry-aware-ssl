...
def main():
    ...
    test_generator = np.random.default_rng(seed=700)
    ...
    d1.save_h5(features=["csm", "cartesian_coordinates", "eigmode", "loc", 'source_strength_analytic' ], f=2500, num=0, split="training", size=62500, name="/mnt/data/zaid/projects/simulated_data/multigeometry_test.h5")
